...
/****************************************************
* Crea los hilos para buscar y gestiona las esperas *
* @param id         id para los buscadores          *
...
{
    std::cout << "Word to search: " << word << std::endl;
    std::this_thread::sleep_for(std::chrono::seconds(1));

    // Creamos el cliente ilimitado y una petición para la cola.
    if (type == 0){
        free_client FreeClient = free_client(id, word, "Free Client");
        std::cout << "Free client with id " << FreeClient.getId() << " created." << std::endl;
    ...
    // Creamos el cliente ilimitado y una petición para la cola.
        ...
        premium_client PremiumClient = premium_client(id, word, "Premium Client", balance);
        std::cout << "Premium client with id " << PremiumClient.getId() << " created." << std::endl;
    ...
    // Creamos el cliente ilimitado y una petición para la cola.
        ...
        std::cout << "Unlimited client " << UnlimitedClient.getId() << " created." << std::endl;
